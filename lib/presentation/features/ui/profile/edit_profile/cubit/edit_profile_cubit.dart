    ...
    return (
      ...
      email: email.isEmpty
          ...
          : (!AppValidators.isValidEmail(email)
                ...
                : null),
      mobile: !AppValidators.isValidSaudiPhone(mobile)
          ? EditProfileFieldError.mobileInvalid
          : null,
    );
  }
    ...
    if (hasError) {
      emit(
        state.copyWith(
          ...
          emailError: () =>
              errors.email != null ? resolve(errors.email!) : null,
          mobileError: () =>
              errors.mobile != null ? resolve(errors.mobile!) : null,
